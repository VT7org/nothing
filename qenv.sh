...
# Function to write variable to .env
write_env() {
    local var_name=$1
    local var_value=$2
    # Write all variables, even if empty or None
...
echo "# Please fill in any empty variables (e.g., BOT_TOKEN, MONGO_DB_URI, etc.) as needed" >> "$ENV_FILE"
echo "" >> "$ENV_FILE"
...
echo "Please review and fill in any empty variables (e.g., BOT_TOKEN, MONGO_DB_URI, etc.) as needed."
