...
async def mentionall(client, message):
    ...
    if message.chat.type == ChatType.PRIVATE:
        return await message.reply("๏ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ᴏɴʟʏ ғᴏʀ ɢʀᴏᴜᴘ-ᴄʜᴀᴛs.")
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("๏ ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ , ᴏɴʟʏ ᴀᴅᴍɪɴs ᴄᴏᴜʟᴅ ᴛᴀɢ ᴍᴇᴍʙᴇʀs. ")

    if message.reply_to_message and message.text:
        return await message.reply("/tagall ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs ᴛʜᴇɴ ʀᴇᴘʟʏ  ᴛᴏ ᴀɴʏ ᴍᴇssᴀɢᴇ...")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        if not msg:
            return await message.reply("/tagall ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴛᴏ ᴀɴʏ ᴍᴇssᴀɢᴇ ᴛᴏ sᴛᴀʀᴛ ᴛᴀɢɢɪɴɢ ᴘʀᴏᴄᴇss...")
    else:
        return await message.reply("/tagall ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴛᴏ ᴀɴʏ ᴍᴇssᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ , ʙᴏᴛ ᴡɪʟʟ sᴛᴀʀᴛ ᴛᴀɢɢɪɴɢ ᴘʀᴏᴄᴇss ...")
    if chat_id in spam_chats:
        return await message.reply("๏ ᴀʜʜ ! ᴘʟᴇᴀsᴇ  ғɪʀsᴛ sᴛᴏᴘ ʀᴜɴɴɪɴɢ ᴍᴇɴᴛɪᴏɴ ᴘʀᴏᴄᴇss ᴛʜᴇɴ ᴛʀʏ ᴀɢᴀɪɴ....")
...
async def cancel_spam(client, message):
    if not message.chat.id in spam_chats:
        return await message.reply("๏ ᴄᴜʀʀᴇɴᴛʟʏ ɪ'ᴍ ɴᴏᴛ ᴛᴀɢɢɪɴɢ Aɴʏᴏɴᴇ.")
    is_admin = False
    try:
