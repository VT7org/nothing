...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            assistants.append(1)
            try:
                await self.one.send_message(config.LOGGER_ID, "Assistant1 Started")
            except:
        ...
        if config.STRING2:
            ...
            assistants.append(2)
            try:
                await self.two.send_message(config.LOGGER_ID, "Assistant2 Started")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            assistants.append(3)
            try:
                await self.three.send_message(config.LOGGER_ID, "Assistant3 Started")
            except:
                LOGGER(__name__).error(
